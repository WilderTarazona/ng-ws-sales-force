...
@Component({
  selector: 'app-retention-retentions',
  templateUrl: './retention-retentions.component.html',
  styleUrls: ['./retention-retentions.component.scss']
})
export class RetentionRetentionsComponent implements OnInit {
